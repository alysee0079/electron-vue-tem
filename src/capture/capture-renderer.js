...
const $btnClose = document.getElementById('tool-close')
const $btnOk = document.getElementById('tool-ok')
const $btnSave = document.getElementById('tool-save')
const $btnReset = document.getElementById('tool-reset')

// const audio = new Audio()
// audio.src = require('./capture.mp3') // 截图音效
...
getScreenSources(imgSrc => {
  ...
  $btnSave.addEventListener('click', () => {
    ...
    remote.dialog.showSaveDialog(
      {
        defaultPath: `yinger_capture_${Math.random().toString(36).substr(2, 10)}_${Date.now()}`,
        filters: [
          {
            name: 'Images',
